...
class TestAstWalker:
    ...
    def test_walk_with_children_recursive(self) -> None:
        ...
        child_node = {"name": "FunctionDefinition", "id": "2", "attributes": {"name": "testFunc"}}
    ...
    def test_walk_with_multiple_children(self) -> None:
        ...
        child1 = {"name": "FunctionDefinition", "id": "2", "attributes": {"name": "func1"}}

        child2 = {"name": "FunctionDefinition", "id": "3", "attributes": {"name": "func2"}}
    ...
    def test_walk_with_list_of_attributes_match(self) -> None:
        ...
        ast_node = {"name": "FunctionCall", "attributes": {"member_name": "call"}}
    ...
    def test_walk_with_list_of_attributes_no_match(self) -> None:
        ...
        ast_node = {"name": "FunctionCall", "attributes": {"member_name": "transfer"}}
    ...
    def test_walk_with_nested_attributes(self) -> None:
        ...
        ast_node = {"name": "ContractDefinition", "attributes": {"name": "TestContract", "contractKind": "contract"}}
    ...
    def test_walk_with_missing_nested_attributes(self) -> None:
        ...
        ast_node = {"name": "ContractDefinition", "attributes": {"name": "TestContract"}}
    ...
    def test_walk_with_deep_nesting(self) -> None:
        ...
        target_node = {"name": "Literal", "attributes": {"value": "42"}}
    ...
    def test_check_attributes_exact_match(self) -> None:
        ...
        node = {"name": "ContractDefinition", "id": "1"}
    ...
    def test_check_attributes_multiple_matches(self) -> None:
        ...
        node = {"name": "ContractDefinition", "id": "1", "src": "0:100:0"}

        attributes = {"name": "ContractDefinition", "id": "1"}
    ...
    def test_check_attributes_no_match(self) -> None:
        ...
        node = {"name": "FunctionDefinition", "id": "1"}
    ...
    def test_check_attributes_value_mismatch(self) -> None:
        ...
        attributes = {"name": "ContractDefinition", "id": "2"}
    ...
    def test_check_list_of_attributes_first_match(self) -> None:
        ...
        node = {"attributes": {"member_name": "delegatecall"}}

        list_of_attributes = [{"attributes": {"member_name": "delegatecall"}}, {"attributes": {"member_name": "call"}}]
    ...
    def test_check_list_of_attributes_second_match(self) -> None:
        ...
        node = {"attributes": {"member_name": "call"}}
    ...
    def test_check_list_of_attributes_no_match(self) -> None:
        ...
        node = {"attributes": {"member_name": "transfer"}}
                                    ...
                                    "children": [
                                        {
                                            ...
                                            "children": [
                                                {"name": "FunctionCall", "attributes": {"member_name": "call"}}
                                            ],
                                        }
                                    ],
                                }
...
class TestAstWalkerEdgeCases:
    ...
    def test_walk_performance_with_large_tree(self) -> None:
        ...
        for i in range(100):
            child = {"name": "Child", "id": str(i), "children": []}
            # Add 10 grandchildren to each child
            for j in range(10):
                grandchild = {"name": "GrandChild" if j % 2 == 0 else "OtherNode", "id": f"{i}_{j}"}
