...
def analyze_bytecode():
    ...
    helper = InputHelper(
        InputHelper.BYTECODE, source=args.source, evm=args.evm, disasm=args.disassembler
    )
...
def main():
    ...
    parser.add_argument(
        "-d",
        "--disassembler",
        help="Choose the disassembler to work with",
        choices=["geas", "pyevmasm", "evmdasm"],
        default="evmdasm",
    )
    parser.add_argument(
